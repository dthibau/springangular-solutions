...
insert into produit (availability,description,hauteur,largeur, longueur,nom,prix_unitaire,reference,fournisseur_id) values (2, 'bli-bli', 150, 210, 300, 'Stuva Fritids', 92.0, 'STU92', 2);
